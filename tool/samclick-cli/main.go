...
import (
	...
	"github.com/kasoshojo/api/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "samclick-cli",
		Short: `CLI client for the samclick service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "api.kasoshojo.com", "API hostname")
