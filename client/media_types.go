...
// DecodeGoaMessage decodes the GoaMessage instance encoded in resp body.
func (c *Client) DecodeGoaMessage(resp *http.Response) (*GoaMessage, error) {
	var decoded GoaMessage
...
// DecodeGoaMessageCollection decodes the GoaMessageCollection instance encoded in resp body.
func (c *Client) DecodeGoaMessageCollection(resp *http.Response) (GoaMessageCollection, error) {
	var decoded GoaMessageCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
...
// DecodeGoaNews decodes the GoaNews instance encoded in resp body.
func (c *Client) DecodeGoaNews(resp *http.Response) (*GoaNews, error) {
	var decoded GoaNews
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeGoaNewsCollection decodes the GoaNewsCollection instance encoded in resp body.
func (c *Client) DecodeGoaNewsCollection(resp *http.Response) (GoaNewsCollection, error) {
	var decoded GoaNewsCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
...
// DecodeGoaSurvey decodes the GoaSurvey instance encoded in resp body.
func (c *Client) DecodeGoaSurvey(resp *http.Response) (*GoaSurvey, error) {
	var decoded GoaSurvey
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeGoaSurveyCollection decodes the GoaSurveyCollection instance encoded in resp body.
func (c *Client) DecodeGoaSurveyCollection(resp *http.Response) (GoaSurveyCollection, error) {
	var decoded GoaSurveyCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
...
// DecodeGoaSurveyanswer decodes the GoaSurveyanswer instance encoded in resp body.
func (c *Client) DecodeGoaSurveyanswer(resp *http.Response) (*GoaSurveyanswer, error) {
	var decoded GoaSurveyanswer
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeGoaSurveyquestion decodes the GoaSurveyquestion instance encoded in resp body.
func (c *Client) DecodeGoaSurveyquestion(resp *http.Response) (*GoaSurveyquestion, error) {
	var decoded GoaSurveyquestion
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeGoaUser decodes the GoaUser instance encoded in resp body.
func (c *Client) DecodeGoaUser(resp *http.Response) (*GoaUser, error) {
	var decoded GoaUser
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
